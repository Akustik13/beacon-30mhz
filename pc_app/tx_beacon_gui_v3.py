#!/usr/bin/env python3
"""TX Beacon GUI v3 — Light/Dark theme, transport abstraction, BLE-ready.
Usage: python tx_beacon_gui_v3.py [--selftest]
"""
...
# ─────────────────────────────────────────────────────────────────────────────
def run_selftest():
    print("=== TX Beacon GUI v3 self-test ===")
    errors = 0
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('TX Beacon v3')
...
def run_gui():
    ...
    app.setApplicationName('TX Beacon v3')
    win = MainWindow()
    win.show()
    sys.exit(app.exec())
