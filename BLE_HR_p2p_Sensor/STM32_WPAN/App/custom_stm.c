...
void SVCCTL_InitCustomSvc(void)
{
  ...
  /* My_P2P_Server service DISABLED — not needed for beacon */
#if 0
...
#endif /* P2P_Server disabled */

  /* My_Heart_Rate service DISABLED — not needed for beacon */
#if 0
  /**
   *          My_Heart_Rate
   *
