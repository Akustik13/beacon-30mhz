 ...
 */
#define CFG_GAP_DEVICE_NAME             "BCN_0000"
 ...
 */
#define CFG_BLE_NUM_GATT_ATTRIBUTES 18
...
typedef enum
{
  ...
  CFG_TASK_BLE_CTRL_ID,   /* deferred BLE ctrl (BLESTART/STOP/PWR) — scheduled by UART task */
...
typedef enum
{
  ...
  CFG_TASK_RF_TX_ID,      /* GPIO only — never paused by HCI */
  CFG_TASK_UART_CMD_ID,   /* UART task must NOT call HCI directly — use BLE_CTRL_ID */
